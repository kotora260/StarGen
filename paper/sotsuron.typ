...
本研究では主に四つの時点のデータに対し解析を行ったが，空間分解能を上げ，時間発展をより詳しく調べることで，明らかとなった分子雲進化シナリオを確認することができると考えられる．また本研究では視線速度，位置，位置からなる三次元の質量データを扱ったが，密度や温度など，その他のパラメータからなるデータも扱うことで，このシミュレーションに対するより深い理解が可能となる．
